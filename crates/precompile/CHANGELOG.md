...
## [17.0.0](https://github.com/sircsq/revm/compare/revm-precompile-v16.0.0...revm-precompile-v17.0.0) - 2025-01-31
...
- fix some typos (#1800)
- Replace `PrecompileError` variant ([#1797](https://github.com/sircsq/revm/pull/1797))
...
- bump k256 and use normalize_s ([#870](https://github.com/sircsq/revm/pull/870))
...
- modexp gas check ([#737](https://github.com/sircsq/revm/pull/737))
